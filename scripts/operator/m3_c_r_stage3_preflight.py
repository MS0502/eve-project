#!/usr/bin/env python3
"""Stage 3: validate paths and memory without loading EVE."""
...
def _clean_exact_head(expected_head: str) -> None:
    ...
    if dirty.strip():
        raise SystemExit("stage 3 requires a clean exact checkout")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    preflight = record_execution_preflight(paths["root"])
    print(
        canonical_json(
            {
                "engine_loaded": False,
