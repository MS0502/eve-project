#!/usr/bin/env python3
"""Durably retain the exact reviewed C2 phone prediction-error observation once."""
...
PUBLIC_RECEIPT_FILENAME = "c2_retention_public_receipt.json"
...
def _repository_head(expected_head: str) -> str:
    ...
    if dirty.strip():
        raise SystemExit("C2 retention requires a clean exact repository checkout")
    return actual
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    store.initialize()
    receipt = append_reviewed_observation(store, public_review)
    public = {
        ...
        "retained_real_observation_count_after_append": 1,
        "schema_version": "eve.m3-b.c2-retention-public-review.v1",
    }
