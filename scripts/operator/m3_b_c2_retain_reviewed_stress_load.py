#!/usr/bin/env python3
"""Durably retain the exact reviewed C2 phone stress-load observation once."""
...
PUBLIC_RECEIPT_FILENAME = "c2_stress_load_retention_public_receipt.json"
...
def _repository_head(expected_head: str) -> str:
    ...
    if dirty.strip():
        raise SystemExit(
            "stress-load C2 retention requires a clean exact repository checkout"
        )
    return actual
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    store.initialize()
    receipt = append_reviewed_stress_load_observation(store, public_review)
    public = {
        ...
        "retained_real_observation_count_after_append": 5,
        "schema_version": "eve.m3-b.c2-stress-load-retention-public-review.v1",
    }
