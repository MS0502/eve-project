...
def main():
    ...
    report["source_membership_passed"] = blocked(build(conclusion_items=[{**valid["conclusion_items"][0], "source_inference_item_id":"missing"}]), "source_inference_item_not_in_context") and blocked(build(conclusion_items=[{**valid["conclusion_items"][0], "source_conclusion_ref_id":"missing"}]), "source_conclusion_ref_not_in_inference_context")
    ...
    report["exact_four_file_scope_passed"] = changed == sorted(EXPECTED)
