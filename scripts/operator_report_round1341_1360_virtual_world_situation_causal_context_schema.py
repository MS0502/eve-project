...
def main():
    ...
    stable_a = build_virtual_world_situation_causal_context("direct_cause_candidate", "s1", "s2", [{**LINK, "link_id":"b"}, {"link_id":"a","source_situation_id":"s3","target_situation_id":"s4","link_kind":"consequence_candidate"}], {"z":1,"a":{"민석":True}})
    stable_b = build_virtual_world_situation_causal_context("direct_cause_candidate", "s1", "s2", [{"link_id":"a","source_situation_id":"s3","target_situation_id":"s4","link_kind":"consequence_candidate"}, {**LINK, "link_id":"b"}], {"a":{"민석":True},"z":1})
    ...
    cf = build_virtual_world_situation_causal_context("counterfactual_cause_candidate", "s1", "s2", [LINK])
