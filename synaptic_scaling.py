"""
Eve Day 7: Synaptic Scaling 구현
실제 뇌의 Homeostatic Plasticity 메커니즘
논문: Turrigiano (1998), van Rossum (2000)
"""
...
def synaptic_scaling():
    ...
    scaling_factors = target_rate / current_rates
    # 보수적 조절 (한 번에 최대 10%)
    scaling_factors = np.clip(scaling_factors, 0.9, 1.1)
    
    # 각 post-synaptic 뉴런에 들어오는 시냅스들 조절
...
print(f"\n뉴런 발화율:")
print(f"  평균: {final_rates.mean():.1f} Hz (목표: {target_rate} Hz)")
