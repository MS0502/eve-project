...
## Round103 operator guide — one command after manual install

After you manually download the Release assets and run the Round102 local restore command, validate the install with:
