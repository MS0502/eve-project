        ...
        try:
            ...
            if lcm is not None:
                ...
                state["lex_concept_mapping"] = {
                    ...
                    "state_debug_audit_replay_viewer_version": stats.get("state_debug_audit_replay_viewer_version"),
                    "legacy_root_blocker_isolation_version": stats.get("legacy_root_blocker_isolation_version"),
                    "broader_validation_triage_report_version": stats.get("broader_validation_triage_report_version"),
                    "sandbox_replay_regression_guard_version": stats.get("sandbox_replay_regression_guard_version"),
                    "operator_go_no_go_package_version": stats.get("operator_go_no_go_package_version"),
                    "round": int(stats.get("round", 117) or 117),
                    ...
                    "state_debug_audit_replay_viewer_available": bool(stats.get("state_debug_audit_replay_viewer_available", False)),
                    "legacy_root_blocker_isolation_available": bool(stats.get("legacy_root_blocker_isolation_available", False)),
                    "broader_validation_triage_report_available": bool(stats.get("broader_validation_triage_report_available", False)),
                    "sandbox_replay_regression_guard_available": bool(stats.get("sandbox_replay_regression_guard_available", False)),
                    "operator_go_no_go_package_available": bool(stats.get("operator_go_no_go_package_available", False)),
                    ...
                    "state_debug_audit_replay_viewer": dict(stats.get("state_debug_audit_replay_viewer", {}) or {}),
                    "legacy_root_blocker_isolation": dict(stats.get("legacy_root_blocker_isolation", {}) or {}),
                    "broader_validation_triage_report": dict(stats.get("broader_validation_triage_report", {}) or {}),
                    "sandbox_replay_regression_guard": dict(stats.get("sandbox_replay_regression_guard", {}) or {}),
                    "operator_go_no_go_package": dict(stats.get("operator_go_no_go_package", {}) or {}),
