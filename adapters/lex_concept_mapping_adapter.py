...
class LexConceptMappingAdapter:
    ...
    def stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "round": int(getattr(self, "_latest_runtime_mapping_round", 96) or 96),
            "runtime_mapping_enabled": bool(getattr(self, "runtime_mapping_enabled", False)),
            "enforcement_enabled": bool(getattr(self, "enforcement_enabled", False)),
            "snapshots_built": 0,
            ...
            "policy": "lexical_vectors_are_evidence_not_agp_anchors_round88_concept_mapping_v0_freeze_read_only_round89_explicit_commit_round90_replay_round91_checkpoint_round92_runtime_mapping_gate_dry_run_round93_runtime_mapping_proposal_disabled_round94_runtime_mapping_enforcement_dry_run_disabled_round95_runtime_mapping_operator_acceptance_fixture_disabled_round96_runtime_mapping_enable_smoke_precheck_disabled_round97_controlled_enable_smoke_ephemeral_round98_persistence_gate_audit_round107_activation_dryrun_disabled_round108_activation_candidate_guarded_disabled_by_default",
            "read_only": False,
        }
